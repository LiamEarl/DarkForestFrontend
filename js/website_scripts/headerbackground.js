export function header_background() {
    const imageStyles = [
        "Menu1.jpg",
        "Menu2.jpg",
        "Menu3.jpg",
    ...
    document.body.style.backgroundImage = "url('../../public/assets/websiteAssets/".concat(imgStyle).concat("')");
    ...
    const comments = [
        ...
        "Real Talk: DO NOT REUSE PASSWORDS BETWEEN APPLICATIONS!",
